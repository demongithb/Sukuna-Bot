...
const miniopcion = `👑 *CONFIGURACIÓN TANJIRO
...
OPCIONES PARA MI CREADOR (ᴅᴀʀᴋ ʙʀxᴢᴢᴢ)*
...
conn.reply(m.chat, `♡⁠(⁠Ӧ⁠ｖ⁠Ӧ⁠｡⁠)  *La Función ${type} Se Ha ${isEnable ? 'Activado' : 'Desactivado'} En Este ${isAll ? 'Bot' : isUser ? '' : 'Chat.'}*`, m, rcanal, )
